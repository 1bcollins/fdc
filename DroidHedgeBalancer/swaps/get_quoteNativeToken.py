...
def get_quote(vault_id: str, chain_type: str, network: str,  sell_token_amount: str, buy_token_address: str, providers: list, slippage: str, access_token: str) -> Dict[str, Any]:
...
if __name__ == "__main__":
	...
	sell_token_amount="1000000000000000"	# 1000000000000000 =.001 eth =~$5
	slippage="100"	#0000000000000"
	print("providers: ", providers)
	print("providers[1]: ", providers[1])
	quote=get_quote(EVM_VAULT_ID, "evm", "ethereum_mainnet",  sell_token_amount, buy_token_address, [providers[1]], slippage, FORDEFI_API_TOKEN)
