...
def upsert_droid_status(droid, nftArray, nftsLiquUSD, lpPosArray, botArray, ratioArray, cursor, connection):
	...
	#risingRebalTrigg=DROID_SESSION[droid['id']]['risingRebalanceTrigger'] if DROID_SESSION[droid['id']]['risingRebalanceTrigger'] else 0.00
	#fallingRebalTrigg=DROID_SESSION[droid['id']]['fallingRebalanceTrigger'] if DROID_SESSION[droid['id']]['fallingRebalanceTrigger'] else 0.00
